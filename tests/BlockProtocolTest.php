 ...
 * @internal
 */
#[CoversClass(BlockProtocol::class)]
final class BlockProtocolTest extends TestCase
{
    ...
    public function testEncodeWithMultipleHandlers(): void
    {
        ...
        // 验证结果是有效的base64
        $this->assertNotSame(false, base64_decode($encodedData, true));
